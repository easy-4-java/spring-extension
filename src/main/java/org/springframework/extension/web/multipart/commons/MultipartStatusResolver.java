package org.springframework.extension.web.multipart.commons;
 ...
 * <p> 3、最后在controller的配置文件中指定resolver： &lt;bean id="multipartResolver" class="org.springframework.extension.web.multipart.commons.MultipartStatusResolver"&gt;&lt;/bean&gt;</p>
 */
